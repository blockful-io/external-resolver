...
contract arbResolverScript is Script, ENSHelper {
    function run() external {
        ...
        address arbitrumL2ResolverAddress = 0x0702AA6Ec5fbC66a4CcdDaaa9B29CB667F6528e3;
        ...
        NameWrapper nameWrap =
            new NameWrapper(registry, IBaseRegistrar(address(registrar)), IMetadataService(publicKey));

        L1Resolver l1resolver = new L1Resolver(1337, verifier, registry, nameWrap);
